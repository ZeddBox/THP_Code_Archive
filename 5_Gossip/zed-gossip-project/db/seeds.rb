...
User.create(first_name:"Julien",last_name:"Anceau",description:"J'aime les Ewoks et l'Inspector Spacetime",email:"jul33anc@gmail.com",age:"28",city_id: City.find_by(name:"Bordeaux").id, password: "123456", password_confirmation: "123456")
